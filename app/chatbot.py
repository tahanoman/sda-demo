...
BASE = os.getenv("BACKEND_BASE_URL", "http://127.0.0.1:5000")

LOAD_CHAT_URL   = f"{BASE}/load_chat/"
SAVE_CHAT_URL   = f"{BASE}/save_chat/"
DELETE_CHAT_URL = f"{BASE}/delete_chat/"
UPLOAD_PDF_URL  = f"{BASE}/upload_pdf/"
CHAT_URL        = f"{BASE}/chat/"
RAG_CHAT_URL    = f"{BASE}/rag_chat/"
